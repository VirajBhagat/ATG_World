...
function Header_Posts() {
    return (
        <div className='main-header-post'>
            <ul className='main-header-post-lists'>
                <li className='main-header-post-list'><a>All Posts</a></li>
                <li className='main-header-post-list'><a>Article</a></li>
                <li className='main-header-post-list'><a>Event</a></li>
                <li className='main-header-post-list'><a>Education</a></li>
                <li className='main-header-post-list'><a>Job</a></li>
            </ul>
            <div className='main-header-post-buttons'>
                <button className='main-header-post-buttons-icon'><span>Write a Post</span><svg width="10" height="5" viewBox="0 0 10 5" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M0.416626 0.166626L4.99996 4.74996L9.58329 0.166626H0.416626Z" fill="black"/>
                    </svg>
                </button>
                <button className='main-header-post-buttons-contact'>
