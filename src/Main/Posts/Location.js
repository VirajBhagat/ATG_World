...
function Location() {
    return (
        <div className='main-all_posts-location'>
            <div className='main-all_posts-location-input'>
                <svg className='location-icon' width="22" height="22" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className='main-all_posts-location-message'>
