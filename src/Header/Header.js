...
import search_photo from '../static files/img/search.png';
    ...
    return (
        <header>
            <div className='header-logo'>
                <h3>
                    <span className='header-logo-ATG'>ATG.</span><span className='header-logo-W'>W
            ...
            <div className='header-signup'>
                <p>Create account. <a onClick={()=>{props.setActiveSignUp(!props.activeSignUp)}}>It's free</a><span></span></p>
            </div>
        </header>
    );
}
